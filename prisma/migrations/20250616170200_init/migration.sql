...
-- CreateIndex
CREATE UNIQUE INDEX "asset_holders_user_id_key" ON "asset_holders"("user_id");
...
-- AddForeignKey
ALTER TABLE "asset_holders" ADD CONSTRAINT "asset_holders_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
